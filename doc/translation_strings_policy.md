...
This document provides guidelines for internationalization of the Nullion Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nullion_en.ts` remains unchanged.
