Nullion Core version 0.9.4 is now available from:

  https://nullion.org/bin/0.9.4/
...
this update is incompatible with the Nullion system and could lead to consensus
forks.

Nullion Core released binaries from https://nullion.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~nullion/+archive/ubuntu/nullion
- A third-party or self-compiled Nullion Core

upgrade to Nullion Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
