...
- #7692 `29b2be6` Remove P2P alert system (nulldrak)
...
- #8275 `042c323` Remove bad chain alert partition check (nulldrak)
...
- #7619 `18b3f1b` Add missing sudo entry in gitian VM setup (nulldrak)
- #7616 `639ec58`  [depends] Delete unused patches  (MarcoFalke)
- #7658 `c15eb28` Add curl to Gitian setup instructions (nulldrak)
...
- #7531 `18cb2d5` Add bip68-sequence.py to extended rpc tests (nulldrak)
...
- #7773 `7c80e72` Fix comments in tests (nulldrak)
...
- #7540 `ff46dd4` Rename OP_NOP3 to OP_CHECKSEQUENCEVERIFY (nulldrak)
