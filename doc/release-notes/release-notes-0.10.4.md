Nullion Core version 0.10.4 is now available from:

  <https://nullion.org/bin/nullion-core-0.10.4/>
...
- #6953 `43c2789` Split nullion-tx into its own package
- #6953 `dfe0d4d` Include nullion-tx binary on Debian/Ubuntu
