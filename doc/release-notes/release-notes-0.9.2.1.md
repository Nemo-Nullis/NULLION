Nullion Core version 0.9.2.1 is now available from:

  https://nullion.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NUTLL to 0.01 NUTLL
...
- Fix "Start nullion on system login"
