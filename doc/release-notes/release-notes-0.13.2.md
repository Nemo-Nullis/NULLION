Nullion Core version 0.13.2 is now available from:

  <https://nullion.org/bin/nullion-core-0.13.2/>
...
- #8908 `4a974b2` Update nullion-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow nullion-tx to create v2 transactions (nutlldrak)
