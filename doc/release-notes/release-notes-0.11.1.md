Nullion Core version 0.11.1 is now available from:

  <https://nullion.org/bin/nullion-core-0.11.1/>
...
(see https://github.com/nullion/nullion/pull/6795).
...
one was randomly violated by all deployed nullion software prior to
...
Nullion Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Nullionj has done so for a similar span of time.
Nullionjs and electrum have been more recently updated.
...
[1] On the Malleability of Nullion Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/nullion/paper_9.pdf
...
(see https://github.com/nullion/nullion/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libnullionconsensus: avoid a crash in multi-threaded environments
