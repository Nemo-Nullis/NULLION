Nullion version 0.5.4 is now available for download at:
http://sourceforge.net/projects/nullion/files/Nullion/nullion-0.5.4/
...
http://gitorious.org/nullion/nulliond-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Nullion-Qt notifications under Growl 1.3.
Increase required age of Nullion-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNullion properly when installing Nullion-Qt over it. (Windows)
