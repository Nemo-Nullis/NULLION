Nullion-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/nullion/files/Nullion/nullion-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Nullion
...
New/changed settings (command-line or nullion.conf file)
--------------------------------------------------------
