...
{
    BOOST_CHECK(TestSplitHost("www.nullioncore.org", "www.nullioncore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.nullioncore.org]", "www.nullioncore.org", 0));
    BOOST_CHECK(TestSplitHost("www.nullioncore.org:80", "www.nullioncore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.nullioncore.org]:80", "www.nullioncore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:20926", "127.0.0.1", 20926));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:20926", "127.0.0.1", 20926));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:20926", "::ffff:127.0.0.1", 20926));
    BOOST_CHECK(TestSplitHost("[::]:20926", "::", 20926));
    BOOST_CHECK(TestSplitHost("::20926", "::20926", 0));
    BOOST_CHECK(TestSplitHost(":20926", "", 20926));
    BOOST_CHECK(TestSplitHost("[]:20926", "", 20926));
    ...
    BOOST_CHECK(TestSplitHost("www.nullioncore.org:65536", "www.nullioncore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.nullioncore.org:0", "www.nullioncore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.nullioncore.org:", "www.nullioncore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:20926", "127.0.0.1:20926"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:20926", "[::]:20926"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
