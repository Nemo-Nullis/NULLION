...
#ifndef NULLION_TEST_SCRIPTNUM10_H
#define NULLION_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Nullion Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // NULLION_TEST_SCRIPTNUM10_H
