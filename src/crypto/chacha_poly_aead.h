...
#ifndef NULLION_CRYPTO_CHACHA_POLY_AEAD_H
#define NULLION_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@nullion.
 *
 ...
 *
 * The chacha20-poly1305@nullion combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@nullion cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@nullion are relatively fast in
...
#endif // NULLION_CRYPTO_CHACHA_POLY_AEAD_H
