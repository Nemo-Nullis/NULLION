...
#ifndef NULLION_ARITH_UINT256_H
#define NULLION_ARITH_UINT256_H
...
public:
     ...
     *
     * Nullion only uses this "compact" format for encoding difficulty
