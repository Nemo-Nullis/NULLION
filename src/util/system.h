 ...
 */
#ifndef NULLION_UTIL_SYSTEM_H
#define NULLION_UTIL_SYSTEM_H
...
extern const char * const NULLION_CONF_FILENAME;
extern const char * const NULLION_SETTINGS_FILENAME;
