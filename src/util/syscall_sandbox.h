...
#ifndef NULLION_UTIL_SYSCALL_SANDBOX_H
#define NULLION_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during nulliond initialization if Nullion Core was compiled
...
#endif // NULLION_UTIL_SYSCALL_SANDBOX_H
