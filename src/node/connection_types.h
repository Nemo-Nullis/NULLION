...
#ifndef NULLION_NODE_CONNECTION_TYPES_H
#define NULLION_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/nullion-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Nullion’s Peer-to-Peer Network")
...
#endif // NULLION_NODE_CONNECTION_TYPES_H
