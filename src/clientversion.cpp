 ...
 * for both nulliond and nullion-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Nullion");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/nullion/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/nullion/nullion>";
