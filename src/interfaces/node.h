...
#ifndef NULLION_INTERFACES_NODE_H
#define NULLION_INTERFACES_NODE_H
...
//! Top-level interface for a nullion node (nulliond process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or nullion.conf.
...
#endif // NULLION_INTERFACES_NODE_H
