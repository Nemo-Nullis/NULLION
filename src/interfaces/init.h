...
#ifndef NULLION_INTERFACES_INIT_H
#define NULLION_INTERFACES_INIT_H
...
//! (nullion-gui, nullion-node, nullion-wallet, nulliond, nullion-qt) and each
...
#endif // NULLION_INTERFACES_INIT_H
