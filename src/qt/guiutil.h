...
#ifndef NULLION_QT_GUIUTIL_H
#define NULLION_QT_GUIUTIL_H
...
/** Utility functions used by the Nullion Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "nullion:" URI into recipient object, return true on successful parsing
