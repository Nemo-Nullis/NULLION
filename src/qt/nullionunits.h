...
#ifndef NULLION_QT_NULLIONUNITS_H
#define NULLION_QT_NULLIONUNITS_H
...
/** Nullion unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NullionUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NullionUnits(QObject *parent);
