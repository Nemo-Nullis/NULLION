...
//! Entry point for NullionApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &NullionApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for NullionGUI tests.
void AppTests::guiTests(NullionGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &NullionGUI::consoleShown, this, &AppTests::consoleTests);
