...
{
    // Test regression https://github.com/nullion/nullion/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/nullion-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/nullion-core/gui/pull/568.
    // With fListen=false in ~/.config/Nullion/Nullion-Qt.conf and all else left as default,
    // nullion-qt should set both -listen and -listenonion to false and start successfully.
