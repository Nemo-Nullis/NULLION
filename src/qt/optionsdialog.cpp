      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->nullionAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->nullionAtStartup);
    ...
    ui->nullionAtStartup->setToolTip(ui->nullionAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->nullionAtStartup->setText(ui->nullionAtStartup->text().arg(PACKAGE_NAME));

    ui->openNullionConfButton->setToolTip(ui->openNullionConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new NullionUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->nullionAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSNUTLLontrols);
...
void OptionsDialog::on_openNullionConfButton_clicked()
{
