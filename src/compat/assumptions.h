...
#ifndef NULLION_COMPAT_ASSUMPTIONS_H
#define NULLION_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Nullion cannot be compiled without assertions."
#endif
...
#endif // NULLION_COMPAT_ASSUMPTIONS_H
