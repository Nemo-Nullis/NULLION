...
#ifndef NULLION_WALLET_TRANSACTION_H
#define NULLION_WALLET_TRANSACTION_H
...
public:
     ...
     * on this nullion node, and set to 0 for transactions that were created
...
#endif // NULLION_WALLET_TRANSACTION_H
