...
#ifndef NULLION_WALLET_WALLETUTIL_H
#define NULLION_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! nullion from opening the wallet, thinking it was newly created, and
...
#endif // NULLION_WALLET_WALLETUTIL_H
