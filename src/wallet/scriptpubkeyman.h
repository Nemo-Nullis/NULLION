...
#ifndef NULLION_WALLET_SCRIPTPUBKEYMAN_H
#define NULLION_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Nullion Core wallet was originally a collection of unrelated private
...
#endif // NULLION_WALLET_SCRIPTPUBKEYMAN_H
