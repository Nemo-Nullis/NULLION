...
#ifndef NULLION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define NULLION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // NULLION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
