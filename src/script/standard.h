...
#ifndef NULLION_SCRIPT_STANDARD_H
#define NULLION_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a nullion address
 */
...
/**
 * Generate a Nullion scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // NULLION_SCRIPT_STANDARD_H
