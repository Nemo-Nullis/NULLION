...
complete --command nullion-qt --no-files

# Extract options
function __fish_nullionqt_get_options
...
complete \
    --command nullion-qt \
    --arguments "(__fish_nullionqt_get_options --nofiles)"
