...
complete --command nulliond --no-files

# Extract options
function __fish_nulliond_get_options
...
complete \
    --command nulliond \
    --arguments "(__fish_nulliond_get_options --nofiles)"
