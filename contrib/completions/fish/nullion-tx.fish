...
# Extract options
function __fish_nullion_tx_get_options
...
# Extract commands
function __fish_nullion_tx_get_commands
...
complete \
    --command nullion-tx \
    --condition "not __fish_nullion_seen_cmd (__fish_nullion_tx_get_commands --commandsonly)" \
    --arguments "(__fish_nullion_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command nullion-tx \
    --arguments "(__fish_nullion_tx_get_commands)" \
    --no-files
