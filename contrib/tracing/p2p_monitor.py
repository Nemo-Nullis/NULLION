...
""" Interactive nulliond P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Nullion Core can enable. It uses BCC
...
def main(nulliond_path):
    ...
    nulliond_with_usdts.enable_probe(
