...
"""Example logging Nullion Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/nulliond
...
def main(nulliond_path):
    ...
    b = BPF(text=program, usdt_contexts=[nulliond_with_usdts])
