...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef NULLION_CHAINPARAMSSEEDS_H\n')
    g.write('#define NULLION_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the nullion network\n')
    ...
    g.write('#endif // NULLION_CHAINPARAMSSEEDS_H\n')
