...
def parse_config_into_null_config():
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/nullion_config.h'), "w", encoding="utf8") as null_config:
        null_config.writelines(template)
