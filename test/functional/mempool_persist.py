...
By default, nulliond will dump mempool on shutdown and
...
class MempoolPersistTest(NullionTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent nulliond from writing mempool.dat to disk. Verify that `savemempool` fails")
