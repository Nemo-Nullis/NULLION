...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/nullion/nullion/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(NullionTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our nulliond node")
