...
"""Verify that starting nullion with -h works as expected."""

from test_framework.test_framework import NullionTestFramework
from test_framework.util import assert_equal

class HelpTest(NullionTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nullion with -h for help text")
        ...
        self.log.info("Start nullion with -version for version information")
        ...
        self.log.info("Start nulliond with -fakearg to make sure it does not start")
