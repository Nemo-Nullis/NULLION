...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/nullion/nullion/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(NullionTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/nullion/nullion/blob/master/doc/tracing.md#tracepoint-validationblock_connected
