...
class ScantxoutsetTest(NullionTestFramework):
    ...
    def run_test(self):
        ...
        # Note that all amounts in the UTXO set are powers of 2 multiplied by 0.001 NUTLL, so each amounts uniquely identifies a subset.
