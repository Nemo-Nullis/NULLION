...
class TestShell:
    """Wrapper Class for NullionTestFramework.

    The TestShell class extends the NullionTestFramework
    ...
    class __TestShell(NullionTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by NullionTestFramework child class.
            self.num_nodes = 1
