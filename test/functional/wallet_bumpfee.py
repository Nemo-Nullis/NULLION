...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Expected fee is 141 vbytes * fee_rate 0.00350250 NULL / 1000 vbytes = 0.00049385 NULL.
    # or occasionally 140 vbytes * fee_rate 0.00350250 NULL / 1000 vbytes = 0.00049035 NULL.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 NULL.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 NULL / 1000 vbytes = 0.00002820 NULL
...
def test_watchonly_psbt(self, peer_node, rbf_node, dest_address):
    ...
    # Ensure the payment amount + change can be fully funded using one of the 0.001NULL inputs.
