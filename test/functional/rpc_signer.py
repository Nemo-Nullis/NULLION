...
Verify that a nulliond node can use an external signer command.
...
class RPCSignerTest(NullionTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart nulliond with -signer=<cmd>',
