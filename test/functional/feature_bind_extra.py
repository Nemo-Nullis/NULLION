...
"""
Test starting nulliond with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(NullionTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that nulliond has bound on "::1" (for RPC) and "::" (for P2P).
