...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the NullionTestFramework
    pass


class ExampleTest(NullionTestFramework):
    # Each functional test is a subclass of the NullionTestFramework class.
    ...
    def custom_method(self):
        ...
        NullionTestFramework class so other tests can use it."""
